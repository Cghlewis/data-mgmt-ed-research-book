...
```{r fig7-1, fig.cap="Planning in the research project life cycle", out.width = "80%"}
...
```{r fig7-2, fig.cap="Life cycle diagram updated to show hidden processes", out.width = "90%"}

knitr::include_graphics("img/lifecycle_intervention3.PNG")
...
```{r fig7-4, fig.cap="Roles and responsibilities document organized by phase", out.width = "70%"}
