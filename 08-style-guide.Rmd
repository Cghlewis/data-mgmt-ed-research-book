...
```{r fig9-1, fig.cap="Style guide in the research project life cycle", out.width = "80%"}
  ...
  data <- project$AddChild("data")
    y1 <- data$AddChild("cohort-1")
      ...
      svy <- studentd$AddChild("survey")
        svyarchive <- svy$AddChild("archive")
        svychange <- svyarchive$AddChild("changelog.txt")
...
```{r fig9-2, fig.cap="xkcd comic on naming files", out.width = "30%"}
...
```{r fig9-3, fig.cap="Examples of how time might be added to your data based on a variety of scenarios"}

knitr::include_graphics("img/time_component.PNG")
...
```{r fig9-4, fig.cap="Example missing value code schema used for numeric variables"}

knitr::include_graphics("img/missing2.PNG")
