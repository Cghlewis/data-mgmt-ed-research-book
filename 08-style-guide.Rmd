...
```{r fig8-1, fig.cap="Style guide in the research project life cycle"}
...
```{r fig8-2, fig.cap="Documents, from Randall Munroe’s xkcd", out.width = "50%"}
...
```{r fig8-3, fig.cap="Examples of how time might be added to your data based on a variety of scenarios"}
