...
```{r fig9-1, out.width = "80%", fig.cap="Tracking in the research project life cycle"}
...
```{r fig9-8, fig.cap="Example form view data entry", out.width= "70%"}
...
```{r fig9-9, fig.cap="Example of a study id schema created using best practices"}
