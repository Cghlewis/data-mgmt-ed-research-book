...
```{r fig9-1, out.width = "70%", fig.cap="Tracking in the research project life cycle"}
...
```{r fig9-2, fig.cap="Participant database built using a relational model"}
...
```{r fig9-3, caption = "Example roster created by querying our relational database tables"}
...
```{r fig9-4, fig.cap="Participant database built in using a non-relational model"}
...
```{r fig9-5, fig.cap="Example participant database model", out.width= "80%"}
...
```{r fig9-6, fig.cap="Example participant database model", out.width= "80%"}

knitr::include_graphics("img/participant4.PNG")
...
```{r fig9-7, fig.cap="Example spreadsheet view data entry"}
...
```{r fig9-8, fig.cap="Example form view data entry", out.width= "80%"}
...
```{r fig9-9, fig.cap="Example of keeping participant IDs for the entire study", out.width= "70%"}
