...
```{r fig9-3, fig.cap = "Example roster created by querying our relational database tables"}

library(tidyverse)

tbl <- tibble::tribble (~t_l_name, ~t_f_name, ~s_l_name, ~s_f_name, ~grade_level,
...
```{r fig9-6, fig.cap="Example spreadsheet view data entry"}
...
```{r fig9-7, fig.cap="Example form view data entry", out.width= "80%"}
...
```{r fig9-8, fig.cap="Example of keeping participant IDs for the entire study", out.width= "70%"}
