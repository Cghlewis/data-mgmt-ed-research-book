...
```{r out.width = "70%", fig.cap="Tracking in the research project life cycle"}
...
```{r fig.cap="Participant database built using a relational model"}
...
```{r fig.cap="Example spreadsheet view data entry"}
...
```{r fig.cap="Example form view data entry", out.width= "80%"}
...
```{r fig.cap="Example of keeping participant IDs for the entire study", out.width= "70%"}
