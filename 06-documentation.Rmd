...
```{r fig.cap="Institute of Education Sciences example readme for conveying information on files in a directory"}
...
```{r fig.cap="A sampling of field metadata standards"}
