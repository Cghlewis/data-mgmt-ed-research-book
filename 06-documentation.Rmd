...
```{r fig.cap="Institute of Education Sciences example readme for conveying information on files in a directory", out.width= "70%"}
...
```{r fig.cap="Codebook content that overlaps and is unique to a data dictionary", out.width = "70%"}
...
```{r fig.cap="Example intake metadata form for figshare repository"}

knitr::include_graphics("img/metadata4.PNG")

```

```{r fig.cap="Common metadata elements"}
...
```{r fig.cap="Example metadata displayed on an ICPSR Open project page", out.width = "70%"}
