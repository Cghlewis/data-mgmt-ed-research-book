...
```{r fig7-5, fig.cap="Example of content to include in an internal data use agreement"}
...
```{r fig7-10, fig.cap="Examples of processes or decisions to develop an SOP for"}
...
```{r fig7-15, fig.cap="Fields to include in a data dictionary", out.width = "90%"}
...
```{r fig7-16, fig.cap="Example student survey data dictionary"}
...
```{r fig7-17, fig.cap="Codebook content that overlaps and is unique to a data dictionary", out.width = "90%"}
...
```{r fig7-18, fig.cap="Example codebook content from the SCOPE Coach Survey", out.width = "80%"}
...
```{r fig7-19, fig.cap="Example intake metadata form for Figshare repository", out.width= "70%"}
...
```{r fig7-20, fig.cap="Common metadata elements", out.width = "80%"}
...
```{r fig7-21, fig.cap="Example metadata displayed on an ICPSR Open project page", out.width = "95%"}
...
```{r fig7-22, fig.cap="A sampling of field metadata standards", out.width= "70%"}
...
```{r fig7-23, fig.cap="A comparison of DDI Version 2 standards to Dublin Core standards", out.width = "70%"}
...
```{r fig7-24, fig.cap="Metadata comparison from an AERA Open project"}
