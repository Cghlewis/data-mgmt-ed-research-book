...
```{r fig7-15, fig.cap="Fields to include in a data dictionary", out.width = "70%"}
...
```{r fig7-17, fig.cap="Codebook content that overlaps and is unique to a data dictionary", out.width = "80%"}
