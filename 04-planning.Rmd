...
```{r fig.cap="A simplified decision-making process", out.width = "60%"}
...
```{r fig.cap="A simple workflow template"}
...
```{r fig.cap="Example student survey workflow"}
...
```{r fig.cap="Example student survey workflow using a swimlane template"}
