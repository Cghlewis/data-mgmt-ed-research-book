...
```{r fig11-7, fig.cap="Example cover sheet for a paper data collection instrument", out.width = "90%"}
...
```{r fig11-8, fig.cap="A series of spot checks that occur with paper data"}
...
```{r fig11-9, fig.cap = "Integrating quality assurance and control into a data collection workflow"}
