...
```{r fig11-4, fig.cap="Comparison of data collection tool benefits"}
...
```{r fig11-5, fig.cap="A comparison of data collected without planning and data collected with planning"}
