...
```{r fig11-1, fig.cap="Data collection in the research project life cycle", out.width = "80%"}
...
```{r fig11-2, fig.cap="A comparison of data collected without planning and data collected with planning"}
...
```{r fig11-3, fig.cap="Common education research data collection methods"}
...
```{r fig11-4, fig.cap="Data collection instrument pilot phases"}
...
```{r fig11-5, fig.cap="Comparison of data collection tool benefits"}
...
```{r fig11-6, fig.cap="Annotated instrument from The Florida State Twin Registry project", out.width = "80%"}
...
```{r fig11-7, fig.cap="Process of creating a de-identified dataset", out.width = "90%"}
...
```{r fig11-8, fig.cap="Example cover sheet for a paper data collection instrument", out.width = "90%"}
...
```{r fig11-9, fig.cap="A series of spot checks that occur with paper data"}
...
```{r fig11-10, fig.cap = "Integrating quality assurance and control into a data collection workflow"}

knitr::include_graphics("img/data_collect_workflow3.PNG")
