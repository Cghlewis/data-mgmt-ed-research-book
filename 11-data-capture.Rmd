...
```{r fig12-1, fig.cap="Data capture in the research project life cycle", out.width = "90%"}
...
```{r fig12-2, fig.cap="Common data capture methods", out.width = "60%"}
...
```{r fig12-3, fig.cap="The flow of the decisions to make regarding the data entry process"}

knitr::include_graphics("img/data_entry_process2.PNG")
...
```{r fig12-4, out.width = "60%", fig.cap="A report displaying differences between two entry files"}
...
```{r fig12-5, fig.cap="Example non-public confidential data request process"}
...
```{r fig12-6, fig.cap="Example variable request for an external data provider"}
...
```{r fig12-7, out.width = "80%", fig.cap="Sample documentation form for an external data provider to complete"}
