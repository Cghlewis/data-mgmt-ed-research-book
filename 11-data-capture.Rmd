...
```{r fig12-5, out.width = "60%", fig.cap="A report displaying differences between two entry files"}
...
```{r fig12-8, out.width = "80%", fig.cap="Sample documentation form for an external data provider to complete"}
