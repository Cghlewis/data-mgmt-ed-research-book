...
```{r fig10-1, fig.cap="Data collection in the research project life cycle"}
...
```{r fig10-2, fig.cap="Common education research data collection methods"}
...
```{r fig10-3, fig.cap="Data collection instrument pilot phases"}
...
```{r fig10-4, fig.cap="A comparison of data collected without planning and data collected with planning"}
...
```{r fig10-5, fig.cap="Annotated parent survey from wave 1 The Florida State Twin Registry project (2018)"}
...
```{r fig10-6, fig.cap="Example cover sheet for a paper data collection instrument"}
...
```{r fig10-7, fig.cap="A series of spot checks that occur with paper data"}
...
```{r fig10-8, fig.cap = "Integrating quality assurance and control into a data collection workflow"}
