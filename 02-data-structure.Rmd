...
```{r fig3-4, fig.cap="A comparison of variables adhering and not adhering to a data type"}
...
```{r fig3-6, fig.cap="A comparison of variables with empty cells and variables with not empty cells"}
...
```{r fig3-8, out.width='70%', fig.cap="Linking data through primary keys"}
...
```{r fig3-9, fig.cap="Linking data through foreign keys"}
...
```{r fig3-10, out.width='70%', fig.cap="Linking data through primary and foreign keys"}
...
```{r fig3-11, out.width='80%', fig.cap="Example linking forms across time in wide format"}
...
```{r fig3-12, out.width='80%', fig.cap="Example linking forms across participants in wide format"}
