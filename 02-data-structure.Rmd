...
```{r out.width='80%', fig.cap="Basic format of a dataset"}
...
```{r out.width='70%', fig.cap="Representation of a cell value"}
...
```{r fig.cap="A comparison of non-rectangular and rectangular data"}
...
```{r fig.cap="A comparison of variables adhering and not adhering to a data type"}
...
```{r fig.cap="A comparison of two things being measured in one variable and two things being measured across two variables"}
...
```{r fig.cap="A comparison of of variables with empty cells and variables with not empty cells"}
...
```{r fig.cap="A comparison of variables with implicit values and variables with explicit values"}

knitr::include_graphics("img/cell_color.PNG")
...
```{r fig.cap="A comparison of data with duplicate cases and data with no duplicate cases"}

knitr::include_graphics("img/duplicate.PNG")
...
```{r out.width='70%', fig.cap="Linking data through primary keys"}

knitr::include_graphics("img/link0.PNG")
...
```{r fig.cap="Linking data through foreign keys"}
...
```{r out.width='70%', fig.cap="Linking data through primary and foreign keys"}
...
```{r out.width='80%', fig.cap="Data structured in wide format"}
...
```{r fig.cap="Data structured in long format"}
