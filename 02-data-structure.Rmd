...
```{r fig2-4, fig.cap="A comparison of variables adhering and not adhering to a data type"}
...
```{r fig3-5, fig.cap="A comparison of two things being measured in one variable and two things being measured across two variables"}
...
```{r fig3-6, fig.cap="A comparison of of variables with empty cells and variables with not empty cells"}
...
```{r fig3-7, fig.cap="A comparison of variables with implicit values and variables with explicit values"}
...
```{r fig3-8, fig.cap="A comparison of data with duplicate cases and data with no duplicate cases"}
...
```{r fig3-12, out.width='80%', fig.cap="Data structured in wide format"}
...
```{r fig3-13, fig.cap="Data structured in long format"}
