...
```{r fig3-9, out.width='90%', fig.cap="Linking data through primary keys"}
...
```{r fig3-10, fig.cap="Linking data through foreign keys", out.width='70%'}
...
```{r fig3-12, fig.cap="Appending data across sites"}
...
```{r fig3-13, out.width='80%', fig.cap="Example linking forms across time in wide format"}
