...
```{r fig15-1, fig.cap="Data sharing in the research project life cycle", out.width = "80%"}

knitr::include_graphics("img/lifecycle_share.PNG")
...
```{r fig15-2, fig.cap="Decisions to be made before publicly sharing study data", out.width = "90%"}

knitr::include_graphics("img/data_share_flow2.PNG")
...
```{r fig15-3, fig.cap="A series of decisions to make when deciding where to share data"}

knitr::include_graphics("img/data_share_location.PNG")
...
```{r fig15-4, fig.cap="An example of a restricted access dataset on ICPSR"}

knitr::include_graphics("img/icpsr_restricted.PNG")
...
```{r fig15-5, fig.cap="An example project-level README", out.width = "80%"}

knitr::include_graphics("img/project_readme.PNG")
...
```{r fig15-6, fig.cap="An example dataset-level README"}

knitr::include_graphics("img/data_readme.PNG")
...
```{r fig15-7, fig.cap="An example of how you might structure your data sharing folder"}

knitr::include_graphics("img/data_sharing_structure.PNG")
