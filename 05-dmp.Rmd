...
```{r fig4-1, fig.cap="Data management plan in the research project life cycle"}

knitr::include_graphics("img/fig4-1.PNG")
...
```{r fig4-2, fig.cap="Example data sources catalog"}

knitr::include_graphics("img/fig4-2.PNG")
