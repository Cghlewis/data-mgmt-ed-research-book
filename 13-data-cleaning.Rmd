...
```{r fig14-1, fig.cap="Data cleaning in the research project life cycle", out.width = "80%"}

knitr::include_graphics("img/lifecycle_clean.PNG")
...
```{r fig14-2, fig.cap="The three phases of data", out.width = "80%"}

knitr::include_graphics("img/clean_data.PNG")
...
```{r fig14-3, fig.cap="Data cleaning checklist", out.width = "80%"}

knitr::include_graphics("img/data_clean_check.PNG")
...
knitr::include_graphics("img/review_raw.PNG")
...
```{r fig14-5, fig.cap="Process of creating a de-identified dataset", out.width = "90%"}
...
```{r fig14-6, fig.cap="Splitting one column into multiple columns", out.width = "80%"}

knitr::include_graphics("img/clean_split.PNG")
...
```{r fig14-7, fig.cap="Normalizing a variable", out.width = "40%"}

knitr::include_graphics("img/clean_normalize.PNG")
...
```{r fig14-8, fig.cap="Standardizing a variable", out.width = "40%"}

knitr::include_graphics("img/clean_standardize.PNG")
...
```{r fig14-9, fig.cap="Reverse coding a variable", out.width = "30%"}

knitr::include_graphics("img/clean_reverse.PNG")
...
```{r fig14-10, fig.cap="An example of merging data across forms from the same participant, in the same wave", out.width = "80%"}

knitr::include_graphics("img/clean_merge.PNG")

```

```{r fig14-11, fig.cap="An example of appending data collected on the same form across sites", out.width = "80%"}

knitr::include_graphics("img/clean_append.PNG")
...
```{r fig14-12, fig.cap="A comparison of long and wide format", out.width = "80%"}

knitr::include_graphics("img/clean_reshape.PNG")
