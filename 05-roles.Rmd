...
knitr::include_graphics("img/lifecycle_rr.PNG")
...
```{r fig.cap="Life cycle diagram updated to show hidden processes", out.width = "90%"}

knitr::include_graphics("img/lifecycle_intervention.PNG")
...
```{r fig.cap="Roles and responsibilities document organized by role", out.width = "70%"}

knitr::include_graphics("img/roles_responsibility1.PNG")

```

```{r fig.cap="Roles and responsibilities document organized by phase", out.width = "70%"}
