...
```{r fig7-1, fig.cap="Planning roles in the research project life cycle."}
...
```{r fig7-2, fig.cap="Life cycle diagram updated to show hidden processes."}
...
```{r fig7-3, fig.cap="Roles and responsibilities document organized by role.", out.width = "70%"}
...
```{r fig7-4, fig.cap="Roles and responsibilities organized by phase.", out.width = "70%"}
