...
```{r fig6-2, fig.cap="A simplified decision-making process"}
...
```{r fig6-4, fig.cap="Example student survey workflow"}
...
```{r fig6-5, fig.cap="Example student survey workflow using a swimlane template"}
