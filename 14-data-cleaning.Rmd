...
```{r fig14-1, fig.cap="Data cleaning in the research project life cycle"}

knitr::include_graphics("img/fig14-1.PNG")
...
```{r fig14-2, fig.cap="The three phases of data"}

knitr::include_graphics("img/fig14-2.PNG")
...
```{r fig14-3, fig.cap="Data cleaning checklist"}

knitr::include_graphics("img/fig14-3.PNG")
...
```{r fig14-4, fig.cap="Reviewing rows and columns in a raw data file"}

knitr::include_graphics("img/fig14-4.PNG")
...
```{r fig14-5, fig.cap="Process of creating a de-identified dataset"}

knitr::include_graphics("img/fig14-5.PNG")
...
```{r fig14-6, fig.cap="Splitting one column into multiple columns"}

knitr::include_graphics("img/fig14-6.PNG")
...
```{r fig14-7, fig.cap="Normalizing a variable", out.width= "50%"}

knitr::include_graphics("img/fig14-7.PNG")
...
```{r fig14-8, fig.cap="Standardizing a variable", out.width= "50%"}

knitr::include_graphics("img/fig14-8.PNG")
...
```{r fig14-9, fig.cap="Reverse coding a variable", out.width= "40%"}

knitr::include_graphics("img/fig14-9.PNG")
...
```{r fig14-10, fig.cap="A comparison of long and wide format"}

knitr::include_graphics("img/fig14-10.PNG")
