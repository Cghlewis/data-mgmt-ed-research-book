...
```{r fig13-1, fig.cap="Data cleaning in the research project life cycle"}
...
```{r fig13-2, fig.cap="The three phases of data"}

knitr::include_graphics("img/fig13-2.PNG")
...
```{r fig13-3, fig.cap="Data cleaning checklist"}

knitr::include_graphics("img/fig13-3.PNG")
...
```{r fig13-4, fig.cap="Reviewing rows and columns in a raw data file"}

knitr::include_graphics("img/fig13-4.PNG")
...
```{r fig13-5, fig.cap="Process of creating a de-identified dataset"}

knitr::include_graphics("img/fig13-5.PNG")
...
```{r fig13-6, fig.cap="Splitting one column into multiple columns"}

knitr::include_graphics("img/fig13-6.PNG")
...
```{r fig13-7, fig.cap="Normalizing a variable", out.width= "50%"}

knitr::include_graphics("img/fig13-7.PNG")
...
```{r fig13-8, fig.cap="Standardizing a variable", out.width= "50%"}

knitr::include_graphics("img/fig13-8.PNG")
...
```{r fig13-9, fig.cap="Reverse coding a variable", out.width= "40%"}

knitr::include_graphics("img/fig13-9.PNG")
...
```{r fig13-10, fig.cap="A comparison of long and wide format"}

knitr::include_graphics("img/fig13-10.PNG")
