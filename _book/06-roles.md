...
![(\#fig:fig7-1)Planning in the research project life cycle](img/lifecycle_rr2.PNG){width=80%}
...
![(\#fig:fig7-2)Life cycle diagram updated to show hidden processes](img/lifecycle_intervention3.PNG){width=90%}
...
![(\#fig:fig7-3)Roles and responsibilities document organized by role](img/roles_responsibility1.PNG){width=70%}
...
![(\#fig:fig7-4)Roles and responsibilities organized by phase](img/roles_responsibility2.PNG){width=70%}
