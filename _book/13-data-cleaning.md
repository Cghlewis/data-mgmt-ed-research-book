...
5. Drop any irrelevant columns not included in your data dictionary
...
> **Note** <br> <br>
In the case of Figure \@ref(fig:fig14-7), this kind of standardization needs to happen before you can perform steps such as joining on names for de-identification purposes.
...
12. Construct additional variables
...
15. Merge and/or append data
    - In this step you can merge and/or append forms within or across time (recall Section \@ref(structure-datastructure)).
      ...
      - Appending is stacking forms on top of each other and columns are matched by variable names. In this case, variable names and variable types should be identical across time in order for the matching to work (see Figure \@ref(fig:fig14-11)).
...
16. Reshape data
    - Recall Section \@ref(structure-reshape) where we reviewed various reasons for structuring your data in wide or long format. 
...
> **Note** <br><br>
Having your time component concatenated to the beginning or end of a variable name, rather than embedded into your variable name (as it is in Figure \@ref(fig:fig14-12)), makes this back and forth restructuring process much easier to do in statistical programs.
