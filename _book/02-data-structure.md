...
> **Note** <br> <br>
It is important to note here, that if your data do not have unique identifiers in your tables, as is in the case of anonymous data, you will be unable to join data horizontally.
...
Let's take a simple example where we collected a survey from two different sites, using two different forms. Those forms were entered into two separate tables and we want to combine that data. Figure \@ref(fig:fig3-12), shows how we could vertically join those tables.

<div class="figure" style="text-align: center">
<img src="img/fig3-12.PNG" alt="Appending data across sites" width="100%" />
<p class="caption">(\#fig:fig3-12)Appending data across sites</p>
</div>
