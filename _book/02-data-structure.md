...
We will talk more about creating these identification variables in our [Data Tracking](#ids) chapter.

**Column attributes**

It is important to know that variables have the following attributes:

1. Unique names (no variable name in a dataset can repeat). We will talk more about variable naming when we discuss [style guides](#style).
