...
![(\#fig:fig6-1)Planning in the research project life cycle](img/lifecycle_plan2.PNG){width=80%}
...
![(\#fig:fig6-2)A simplified decision-making process](img/decision-diagram.PNG){width=60%}
...
![(\#fig:fig6-3)A simple workflow template](img/workflow1.PNG){width=100%}

Here is how we might complete this diagram for a student survey.

![(\#fig:fig6-4)Example student survey workflow](img/workflow2.PNG){width=100%}
...
![(\#fig:fig6-5)Example student survey workflow using a swimlane template](img/swimlane2.PNG){width=100%}
...
![(\#fig:fig6-6)Example student survey workflow using a Gantt chart](img/gantt.PNG){width=100%}
