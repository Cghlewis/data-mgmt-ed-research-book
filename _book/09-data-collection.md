...
3. Use data validation to reduce errors and missing data [@uk_data_service_quality_nodate]
    - Content validation
      - Restrict variables to the type assigned in your data dictionary (e.g., numeric)
      - Restrict variables to the format assigned in your data dictionary (e.g., YYYY-MM-DD)
...
> **Note** <br> <br>
If your paper forms are mailed back to you from participants, it is still important to do those in-office spot checks for the data errors mentioned above. If at all possible, reach out to those participants for any corrections.

> **Note** <br> <br>
If you collect data via recording devices (either in person or remotely), make sure to consider privacy and protecting identities of participants throughout the process.<br><br>
- Choose software that is compliant with relevant policies and deemed secure by your institution  
- Choose hardware that is deemed secure by your institution  
- Make sure you have permission to record everyone that is in the screen. If someone has not consented, they will need to be placed outside of the view of the recording.  
- Don't use names in recordings  
- Remove images and names from walls in rooms  
- Put signs on doors informing people to not enter the room during a recording<br><br>
