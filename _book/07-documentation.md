...
The last step of creating your data dictionary, as it should be for every document you create in this documentation phase, is to review the document/s with your team. Gather PIs, key project staff, and other decision makers (e.g., methodologists) in a data management working group (DMWG) [@van_bochove_data_2023] and review the following types of questions:
