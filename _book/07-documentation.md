...
![(\#fig:fig8-1)Data documentation in the research project life cycle](img/lifecycle_doc.PNG){width=80%}
...
![(\#fig:fig8-2)Team-level documentation in the research project life cycle](img/lifecycle_teamdoc2.PNG){width=70%}
...
![(\#fig:fig8-3)Example team wiki with links to frequently requested information](img/wiki3.PNG){width=100%}
...
![(\#fig:fig8-4)Sample data topics to add to onboarding and offboarding checklists](img/onboard_offboard2.PNG){width=100%}
...
![(\#fig:fig8-5)Example of a team data inventory](img/data_inventory.PNG){width=100%}
...
![(\#fig:fig8-6)Example of content to include in a data security policy](img/data_security_plan.PNG){width=100%}
...
![(\#fig:fig8-7)Common research protocol elements](img/protocol2.PNG){width=100%}
...
![(\#fig:fig8-8)Example data collection timeline](img/timeline.PNG){width=100%}
...
![(\#fig:fig8-9)Example participant flow diagram](img/consort2.PNG){width=70%}
...
![(\#fig:fig8-10)Flowchart of an ECLS-K:2011 kindergarten assessment](img/flowchart.PNG){width=70%}
...
![(\#fig:fig8-11)Examples of data management processes or decisions to develop an SOP for](img/sopchecks.PNG){width=100%}
...
![(\#fig:fig8-12)Standard operating procedure minimal template](img/sop.PNG){width=75%}
...
![(\#fig:fig8-13)Institute of Education Sciences example README for conveying information on files in a directory](img/readme3.PNG){width=75%}
...
![(\#fig:fig8-14)Example changelog for a clean student survey data file](img/changelog.PNG){width=100%}
...
![(\#fig:fig8-15)A simplistic data cleaning plan](img/data_cleaning_plan3.PNG){width=60%}
...
![(\#fig:fig8-16)The many uses for a data dictionary](img/dictionary_map.PNG){width=90%}
...
![(\#fig:fig8-17)Fields to include in a data dictionary](img/dictionary.PNG){width=90%}
...
![(\#fig:fig8-18)Pulling relevant information for the Connor Davidson Resilience Scale (CD-RISC)](img/cdrisc.PNG){width=90%}
...
![(\#fig:fig8-19)Example student survey data dictionary](img/dictionary3.PNG){width=100%}
...
![(\#fig:fig8-20)Codebook content that overlaps and is unique to a data dictionary](img/codebook.PNG){width=90%}
...
![(\#fig:fig8-21)Example codebook from the SCOPE Coach Survey](img/codebook2.PNG){width=80%}
...
![(\#fig:fig8-22)Example intake metadata form for Figshare repository, captured January 13, 2023](img/metadata4.PNG){width=70%}

The most common metadata elements [@dahdul_research_2023; @hayslett_libguides_2022] are included in Figure \@ref(fig:fig8-23).

![(\#fig:fig8-23)Common metadata elements](img/metadata.PNG){width=80%}
...
![(\#fig:fig8-24)Example metadata displayed on an ICPSR Open project page](img/metadata_project.PNG){width=95%}
...
![(\#fig:fig8-25)A sampling of field metadata standards](img/metadata_standards.PNG){width=70%}
...
![(\#fig:fig8-26)A comparison of DDI Version 2 standards to Dublin Core standards](img/metadata_mapping.PNG){width=70%}
...
![(\#fig:fig8-27)Metadata comparison from an AERA Open project](img/standard_compare.PNG){width=100%}
