...
<img src="img/fig8-1.PNG" alt="Documentation in the research project life cycle." width="100%" />
<p class="caption">(\#fig:fig8-1)Documentation in the research project life cycle.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="img/fig8-5.PNG" alt="Example data inventory document." width="100%" />
<p class="caption">(\#fig:fig8-5)Example data inventory document.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="img/fig8-6.PNG" alt="Example of content to include in a team data security policy." width="100%" />
<p class="caption">(\#fig:fig8-6)Example of content to include in a team data security policy.</p>
</div>
...
9. Merge in treatment from roster file
...
<div class="figure" style="text-align: center">
<img src="img/fig8-16.PNG" alt="Pulling relevant information for the Math Anxiety Scale for Teachers (MAST)." width="100%" />
<p class="caption">(\#fig:fig8-16)Pulling relevant information for the Math Anxiety Scale for Teachers (MAST).</p>
</div>
...
- If the data source is non-public, request documentation ahead of time from the provider (see Section \@ref(capture-extant)).
...
<div class="figure" style="text-align: center">
<img src="img/fig8-20.PNG" alt="A sampling of field metadata standards." width="100%" />
<p class="caption">(\#fig:fig8-20)A sampling of field metadata standards.</p>
</div>
