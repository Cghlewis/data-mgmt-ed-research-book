...
It can be difficult to estimate the costs of everything that is associated with the vast landscape of managing data. The necessary dollar amount will vary depending on the size of your project, the expertise needed, and your specific data management plan. Recommendations suggest budgeting anywhere from 5-30% of your budget for data stewardship [@mons_invest_2020; @reynolds_data_2014]. Luckily a few organizations have developed resources to aid in estimating these costs. Exercise caution when using tools though; they may not always account for every cost and could result in an underestimation of costs [@michigan_state_university_budgeting_2023].
