...
3. Sample rostering
    - At any time you can pull a study roster from this database that accurately reflects a participant's current status. The tracking information contained in this tool also aids in the creation of documentation including the flow of participants in your [CONSORT diagram](#supplement).
4. Data cleaning
    ...
    - Furthermore, this database can be used for de-identifying data and merging in participant identifiers as needed, or merging in other assigned variables contained in the database such as treatment or cohort.
...
1. Group attribute types of an entity (students, teachers, schools) and purpose
2. Create tables for those entities
...
```{=html}
<div id="uknailqnxm" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#uknailqnxm .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#uknailqnxm .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#uknailqnxm .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#uknailqnxm .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#uknailqnxm .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#uknailqnxm .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#uknailqnxm .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#uknailqnxm .gt_from_md > :first-child {
  margin-top: 0;
}

#uknailqnxm .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#uknailqnxm .gt_row_group_first td {
  border-top-width: 2px;
}

#uknailqnxm .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#uknailqnxm .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#uknailqnxm .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#uknailqnxm .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#uknailqnxm .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#uknailqnxm .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#uknailqnxm .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#uknailqnxm .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#uknailqnxm .gt_font_normal {
  font-weight: normal;
}

#uknailqnxm .gt_font_bold {
  font-weight: bold;
}

#uknailqnxm .gt_font_italic {
  font-style: italic;
}
...
#uknailqnxm .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#uknailqnxm .gt_slash_mark {
  font-size: 0.7em;
  line-height: 0.7em;
  vertical-align: 0.15em;
}

#uknailqnxm .gt_fraction_numerator {
  font-size: 0.6em;
  line-height: 0.6em;
  vertical-align: 0.45em;
}

#uknailqnxm .gt_fraction_denominator {
  font-size: 0.6em;
  line-height: 0.6em;
...
If your study includes a variety of related entities, tracked over waves of time, a relational database will be very helpful to build. If however, you are only tracking one entity (ex: just students) for one wave of data collection, then a database might be overkill and a simple spreadsheet will work just fine.
...
- Other changing information relevant to project coordination (grade level)
- Notes
...
3. The identifier must be randomly assigned and be completely distinct from any participant information
