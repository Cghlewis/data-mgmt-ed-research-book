...
```{r fig2-1, fig.cap="Basic format of a dataset"}
...
```{r fig2-2, fig.cap="Representation of a cell value"}

knitr::include_graphics("img/fig2-2.PNG")
...
```{r fig2-3, fig.cap="A comparison of non-rectangular and rectangular data"}

knitr::include_graphics("img/fig2-3.PNG")
...
```{r fig2-4, fig.cap="A comparison of inconsistent and uniform variable values"}

knitr::include_graphics("img/fig2-4.PNG")
...
```{r fig2-5, fig.cap="A comparison of variables adhering and not adhering to a data type"}

knitr::include_graphics("img/fig2-5.PNG")
...
```{r fig2-6, fig.cap="A comparison of two things being measured in one variable and two things being measured across two variables"}

knitr::include_graphics("img/fig2-6.PNG")
...
```{r fig2-7, fig.cap="A comparison of variables with empty cells and variables with not empty cells"}

knitr::include_graphics("img/fig2-7.PNG")
...
```{r fig2-8, fig.cap="A comparison of variables with implicit values and variables with explicit values"}

knitr::include_graphics("img/fig2-8.PNG")
...
```{r fig2-9, fig.cap="Three tables with primary and foreign keys"}

knitr::include_graphics("img/fig2-9.PNG")
...
```{r fig2-10, fig.cap="Linking data through primary keys"}

knitr::include_graphics("img/fig2-10.PNG")
...
```{r fig2-11, fig.cap="Linking data through foreign keys"}

knitr::include_graphics("img/fig2-11.PNG")
...
```{r fig2-12, fig.cap="Linking data through primary and foreign keys"}

knitr::include_graphics("img/fig2-12.PNG")
...
```{r fig2-13, fig.cap="Appending data across sites"}

knitr::include_graphics("img/fig2-13.PNG")
...
```{r fig2-14, fig.cap="Example linking forms across time in wide format"}

knitr::include_graphics("img/fig2-14.PNG")
...
```{r fig2-15, fig.cap="Example linking forms across time in long format"}

knitr::include_graphics("img/fig2-15.PNG")
