...
```{r fig8-16, fig.cap="Pulling relevant information for the Math Anxiety Scale for Teachers (MAST) from a publication"}
...
```{r fig8-20, fig.cap="Example metadata displayed on an ICPSR Child and Family Data Archive project"}
...
```{r fig8-21, fig.cap="A sampling of field metadata standards"}

knitr::include_graphics("img/fig8-21.PNG")
...
```{r fig8-22, fig.cap="Comparing a Dublin Core metadata file and a DDI 2.5 metadata file from an ICPSR Child and Family Data Archive Project"}

knitr::include_graphics("img/fig8-22.PNG")
