...
```{r fig10-5, fig.cap="Example participant database relational model using two separate tables for tracking across waves.", out.width="80%"}
...
```{r fig10-6, fig.cap="Example participant database relational model using one table to track data across waves.", out.width= "80%"}
...
```{r fig10-10, fig.cap="Example of keeping the same participant IDs for the entire study.", out.width = "70%"}
