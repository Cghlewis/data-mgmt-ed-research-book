...
```{r fig15-1, fig.cap="Data sharing in the research project life cycle"}
...
```{r fig15-2, fig.cap="Decisions to be made before publicly sharing study data"}

knitr::include_graphics("img/fig15-2.PNG")
...
knitr::include_graphics("img/fig15-3.PNG")
...
```{r fig15-4, fig.cap="An example of a restricted access dataset on ICPSR's Child and Family Data Archive"}

knitr::include_graphics("img/fig15-4.PNG")
