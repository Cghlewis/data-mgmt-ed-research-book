...
```{r fig9-1, fig.cap="Style guide in the research project life cycle"}
...
```{r fig9-2, fig.cap="Documents, from xkcd.com", out.width = "50%"}
...
```{r fig9-3, fig.cap="Examples of adding to your data based on a variety of scenarios"}
