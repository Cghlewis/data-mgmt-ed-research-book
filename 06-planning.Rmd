...
```{r fig5-1, fig.cap="Planning in the research project life cycle"}
...
```{r fig5-2, fig.cap="A simplified decision-making process"}
...
knitr::include_graphics("img/fig5-3.PNG")

```

Figure \@ref(fig:fig5-4) is how we might complete a very simplified diagram for a student survey.

```{r fig5-4, fig.cap="Example simplified student survey workflow"}

knitr::include_graphics("img/fig5-4.PNG")
...
knitr::include_graphics("img/fig5-5.PNG")
...
knitr::include_graphics("img/fig5-6.PNG")
