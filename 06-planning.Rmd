...
```{r fig6-1, fig.cap="Planning in the research project life cycle."}

knitr::include_graphics("img/fig6-1.PNG")
...
```{r fig6-2, fig.cap="A simplified decision-making process.", out.width = "80%"}

knitr::include_graphics("img/fig6-2.PNG")
...
```{r fig6-3, fig.cap="A simple workflow template."}

knitr::include_graphics("img/fig6-3.PNG")

```

Figure \@ref(fig:fig6-4) is how we might complete a simplified diagram for a student survey.

```{r fig6-4, fig.cap="Example simplified student survey workflow."}

knitr::include_graphics("img/fig6-4.PNG")
...
```{r fig6-5, fig.cap="Example student survey workflow using a swimlane diagram."}

knitr::include_graphics("img/fig6-5.PNG")
...
```{r fig6-6, fig.cap="Example student survey workflow using a Gantt chart"}

knitr::include_graphics("img/fig6-6.PNG")
