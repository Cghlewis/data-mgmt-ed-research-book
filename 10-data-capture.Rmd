...
```{r fig11-3, fig.cap="A flow of the decisions to made regarding the data entry process"}
...
```{r fig11-5, fig.cap="Example variable request for an external partner"}
...
```{r fig11-6, out.width = "80%", fig.cap="Sample documentation form for an external partner to complete"}
