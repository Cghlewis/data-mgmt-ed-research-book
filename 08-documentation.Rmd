...
```{r fig7-1, fig.cap="Data documentation in the research project life cycle"}

knitr::include_graphics("img/fig7-1.PNG")
...
```{r fig7-2, fig.cap="Team-level documentation in the research project life cycle"}
...
knitr::include_graphics("img/fig7-3.PNG")
...
knitr::include_graphics("img/fig7-4.PNG")
...
```{r fig7-5, fig.cap="Example of a team data inventory"}

knitr::include_graphics("img/fig7-5.PNG")
...
```{r fig7-6, fig.cap="Example of content to include in a data security policy"}

knitr::include_graphics("img/fig7-6.PNG")
...
```{r fig7-7, fig.cap="Common research protocol elements"}

knitr::include_graphics("img/fig7-7.PNG")
...
```{r fig7-8, fig.cap="Example data collection timeline"}

knitr::include_graphics("img/fig7-8.PNG")
...
```{r fig7-9, fig.cap="Example participant flow diagram"}

knitr::include_graphics("img/fig7-9.PNG")
...
```{r fig7-10, fig.cap="Example instrument decision making flowchart"}

knitr::include_graphics("img/fig7-10.PNG")
...
```{r fig7-11, fig.cap="Examples of data management SOPs to create"}

knitr::include_graphics("img/fig7-11.PNG")
...
```{r fig7-12, fig.cap="Standard operating procedure minimal template"}

knitr::include_graphics("img/fig7-12.PNG")
...
```{r fig7-13, fig.cap="Example README for conveying information about files in a directory"}

knitr::include_graphics("img/fig7-13.PNG")
...
```{r fig7-14, fig.cap="Example changelog for a clean student survey data file"}

knitr::include_graphics("img/fig7-14.PNG")
...
```{r fig7-15, fig.cap="The many uses for a data dictionary"}

knitr::include_graphics("img/fig7-15.PNG")
...
```{r fig7-16, fig.cap="Pulling relevant information for the Math Anxiety Scale for Teachers (MAST) from a 2019 publication"}

knitr::include_graphics("img/fig7-16.PNG")
...
```{r fig7-17, fig.cap="Example teacher survey data dictionary"}

knitr::include_graphics("img/fig7-17.PNG")
...
```{r fig7-18, fig.cap="Example teacher survey codebook content"}

knitr::include_graphics("img/fig7-18.PNG")
...
```{r fig7-19, fig.cap="Example metadata intake form for OSF"}

knitr::include_graphics("img/fig7-19.PNG")
...
```{r fig7-20, fig.cap="Example metadata displayed on an ICPSR Child and Family Data Archive project"}

knitr::include_graphics("img/fig7-20.PNG")
...
```{r fig7-21, fig.cap="A sampling of field metadata standards"}

knitr::include_graphics("img/fig7-21.PNG")
...
tibble::tribble (~"DC Element", ~"DDI Element", ~"Notes",
  ...
  knitr::kable(caption = "A comparison of Dublin Core standards to DDI Version 2 standards")
...
```{r fig7-22, fig.cap="Comparing a Dublin Core metadata file and a DDI 2.5 metadata file from an ICPSR Child and Family Data Archive Project"}

knitr::include_graphics("img/fig7-22.PNG")
