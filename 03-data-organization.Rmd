...
```{r fig2-10, fig.cap="Linking data through primary keys", out.width="70%"}
...
```{r fig2-14, fig.cap="Example linking tables across time in wide format"}
...
```{r fig2-15, fig.cap="Example linking tables across time in long format"}
