...
```{r fig10-1, fig.cap="Data collection in the research project life cycle", out.width = "70%"}
...
```{r fig10-2, fig.cap="A comparison of data collected without planning and data collected with planning"}

knitr::include_graphics("img/bad_data_collect.PNG")
...
```{r fig10-3, fig.cap="Common topics to include in an informed consent information sheet"}
...
```{r fig10-4, fig.cap="Common education research data collection methods"}

knitr::include_graphics("img/data_collected5.PNG")
...
```{r fig10-5, fig.cap="Questionnaire pilot phases"}

knitr::include_graphics("img/pilot2.PNG")
...
```{r fig10-6, fig.cap="Comparison of data collection tool benefits"}

knitr::include_graphics("img/collect_benefits.PNG")
...
```{r fig10-7, fig.cap="Annotated instrument from The Florida State Twin Registry project", out.width = "80%"}

knitr::include_graphics("img/annotated_instrument.PNG")
...
```{r fig10-8, fig.cap="Process of creating a de-identified dataset", out.width = "90%"}

knitr::include_graphics("img/de-identify.PNG")
...
```{r fig10-9, fig.cap="Example cover sheet for a paper data collection instrument", out.width = "90%"}

knitr::include_graphics("img/cover_sheet.PNG")
...
```{r fig10-10, fig.cap="A series of spot checks that occur with paper data"}

knitr::include_graphics("img/spot_check.PNG")
...
```{r fig10-11, fig.cap="Integrating quality assurance and control into a data collection workflow"}

knitr::include_graphics("img/data_collect_workflow2.PNG")
